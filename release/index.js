    ...
    return _a = class Fetch extends Async__default["default"] {
            ...
            constructor(url, options = {}) {
                super(() => fetch(url, options).then(response => {
                    tslib.__classPrivateFieldSet(this, _Fetch_responseTemp, response, "f");
                ...
                this.options = (tslib.__runInitializers(this, _instanceExtraInitializers), options);
                _Fetch_response_accessor_storage.set(this, tslib.__runInitializers(this, _private_response_initializers, void 0));
                _Fetch_responseTemp.set(this, void 0);
            }
            resolve(value) {
                tslib.__classPrivateFieldSet(this, _Fetch_instances, tslib.__classPrivateFieldGet(this, _Fetch_responseTemp, "f"), "a", _Fetch_response_set);
